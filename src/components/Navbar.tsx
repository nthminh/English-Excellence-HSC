...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-navy text-cream shadow-lg">
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === item.path ? "text-gold border-b-2 border-gold" : "text-cream/80"
                )}
              >
                {item.name}
              </Link>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-navy border-t border-cream/10">
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === item.path ? "text-gold bg-cream/5" : "text-cream/80 hover:text-gold hover:bg-cream/5"
                )}
              >
                {item.name}
              </Link>
